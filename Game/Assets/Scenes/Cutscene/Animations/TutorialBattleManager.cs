...
public class TutorialBattleManager : SceneScript
{
    public override IEnumerator RunAnimation()
    {
        ...
        db.Enqueue("Tutorial§Welcome to the battle arena!");
        ...
        db.Enqueue("Tutorial§Next, we have the 'Ability Description'.");
        db.Enqueue("Tutorial§Here, you can view the description of the applied ability such as the skill level, the mana cost and the cooldown.");
